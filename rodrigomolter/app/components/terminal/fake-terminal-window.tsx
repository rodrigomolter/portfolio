...
export function FakeTerminalWindow({ children }: { children: ReactNode }) {
  return (
    <div className="w-5/6 md:max-w-screen-sm lg:max-w-screen-lg mx-auto md:w-full rounded-xl shadow-lg text-lg border border-black/20">
      {/* top bar */}
      ...
      {/* bottom content */}
      <div className="bg-base-300 py-6 px-10 rounded-b-xl ">
